      ...
      <div className="mx-auto max-w-[1500px]">
        ...
        <section>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            ...
            <a
              href="/admin/reviews"
              className="group rounded-3xl border border-gray-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:border-yellow-400 hover:shadow-md"
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                ...
                <span className="text-xl text-gray-300 transition group-hover:translate-x-1 group-hover:text-yellow-500">
                  →
                </span>
              </div>
            ...
            <a
              ...
              className="group rounded-3xl border border-cyan-200 bg-white p-7 shadow-sm transition hover:-translate-y-1 hover:border-cyan-500 hover:shadow-md"
            >
              <div className="flex items-start justify-between gap-4">
                <div>
                ...
                <span className="text-xl text-gray-300 transition group-hover:translate-x-1 group-hover:text-cyan-600">
                  →
                </span>
              </div>
